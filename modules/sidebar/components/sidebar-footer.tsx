...
export function SidebarFooter({ collapsed }: SidebarFooterProps) {
  return (
    <div className={cn("flex items-center gap-2 px-2 py-3", collapsed && "flex-col")}>
      <NewChatButton />
      {!collapsed && (
        <button className="flex flex-1 cursor-pointer items-center gap-2 rounded-xl border border-border px-3 py-2 text-left text-sm text-muted transition-colors hover:bg-black/5 dark:hover:bg-white/5">
